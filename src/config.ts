...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		// {
		//   src: 'https://q2.qlogo.cn/headimg_dl?dst_uin=167977553&spec=5',    // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "My Page",
			url: "https://page.chksz.top", // Internal links should not include the base path, as it is automatically added
